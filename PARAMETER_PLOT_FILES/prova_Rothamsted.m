...
% x1=1;
% x2=105192;% 276096;
dateNum1 = datenum(2009, 1, 1, 0, 0, 0);
dateNum2 = datenum(2013, 12, 31, 23, 0, 0);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%
t_bef= -0.67; t_aft= 1.67; % How to get this?
%%%%%%%%%%%%%%%%%%%%
...
PARAM_IC = [current_directory filesep 'MOD_PARAM_' id_location];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Directory = uigetdir('Window','Insert Directory Noname Package') ;
Directory=['..' filesep 'T&C_CODE'];
cd(Directory)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MAIN_FRAME ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
file_to_save = ['..' filesep 'results' filesep 'Intermediate-spinup_' id_location '.mat'];
% save(file_to_save);
% B_end = P(end, :);
% save(['..' filesep 'results' filesep 'Rothamsted_biogeo_spinup-B_end-curr.mat'], "B_end");
%%%%%%%%%%%%%%%%%%%%%%%%